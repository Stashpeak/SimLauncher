...
const GameRowComponent = function GameRow({
  game,
  isActive,
  isRunning,
  isGameRunning,
...
export const GameRow = memo(GameRowComponent, (prev, next) => {
  if (
  ...
  if (prev.runningAppIcons.length !== next.runningAppIcons.length) return false
