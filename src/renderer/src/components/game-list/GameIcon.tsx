...
//
// The centre deliberately has NO `bg-` utility here: App.css owns the ring's
// background (transparent, so the row and the icon's own shadow show through,
// #896) next to the forced-colors rule that gives it a `Canvas` fill, and a
// utility would race that stylesheet rule on equal specificity. The amber is
