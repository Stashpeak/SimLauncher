  ...
  return (
    <div className="animate-fade-slide space-y-8 pb-10">
      ...
      <section className="space-y-4">
        ...
        <div
          className={`grid transition-all duration-300 ${gamesOpen ? 'grid-rows-[1fr]' : 'grid-rows-[0fr]'}`}
        >
      ...
      <section className="space-y-4">
        ...
        <div
          className={`grid transition-all duration-300 ${appsOpen ? 'grid-rows-[1fr]' : 'grid-rows-[0fr]'}`}
        >
          <div className="overflow-hidden">
            <div className="glass-surface rounded-2xl flex flex-col pt-1">
              {utilities.map((u) => (
                    ...
                    {u.isCustom ? (
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setAppNames((prev) => ({ ...prev, [u.key]: e.target.value }))
                          }
