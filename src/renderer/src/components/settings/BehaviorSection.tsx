        ...
        <div className="settings-control" role="group" aria-label="Launch delay between apps">
          ...
          >
            ...
            <input
              ...
              className="w-full bg-transparent pl-1 text-right text-[11px] font-semibold text-(--text-primary) outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none focus-visible:ring-2 focus-visible:ring-(--accent)"
              placeholder="0.0"
            />
